...
export const WordleGame = ({ settings }: WordleGameProps) => {
  ...
  const difficultyLabel = `${localSettings.difficulty.charAt(0).toUpperCase()}${localSettings.difficulty.slice(1)}`;
          ...
          <div className="flex flex-col gap-6 sm:flex-row sm:items-center sm:justify-between">
            <div>
              ...
              <div className="mt-4 flex flex-wrap gap-2 text-xs font-medium text-slate-500">
                <span className="rounded-full border border-slate-200 px-3 py-1 uppercase tracking-[0.2em] text-slate-600 dark:border-slate-700 dark:text-slate-300">
                  Theme: {categoryLabels[localSettings.category]}
                </span>
                <span className="rounded-full border border-slate-200 px-3 py-1 uppercase tracking-[0.2em] text-slate-600 dark:border-slate-700 dark:text-slate-300">
                  Difficulty: {difficultyLabel}
                </span>
                <span className="rounded-full border border-slate-200 px-3 py-1 uppercase tracking-[0.2em] text-slate-600 dark:border-slate-700 dark:text-slate-300">
                  Length: {localSettings.wordLength}
                </span>
              </div>
            </div>
