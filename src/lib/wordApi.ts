...
const FALLBACK_WORD_BANK: Record<WordCategory, Record<Difficulty, string[]>> = {
  normal: {
    easy: [
      ...
      'MEAL', 'SONG', 'LANE', 'APPLE', 'SMILE', 'LIGHT', 'HAPPY', 'BLOOM', 'PEACE', 'NIGHT', 'CLOUD', 'BREAD', 'MUSIC',
      'DREAM', 'BRAVE', 'GREEN', 'LAUGH', 'SWEET', 'RIVER', 'SHINE', 'STORY', 'PLANT', 'HOUSE', 'BUTTER', 'CANDLE', 'GARDEN',
      'SUMMER', 'BRIGHT', 'MELLOW', 'SPROUT', 'WARMTH', 'SMILEY', 'AMAZING', 'RAINBOW', 'SUNSHINE', 'ADORABLE', 'CHEERFUL',
      'SERENE', 'CUDDLE', 'GIGGLE', 'JOLLY', 'BUBBLE', 'PETALS', 'MEADOW', 'BREEZY', 'SPRING', 'VELVET', 'SOOTHE', 'PASTEL',
      'AURORA', 'BALMY', 'BERRY', 'BLOSSOM', 'BREEZE', 'BUNNY', 'BUTTERUP', 'CHARM', 'CINNAMON', 'DAISY', 'DELIGHT', 'ELATE',
      'FLUFFY', 'FONDUE', 'GENTLE', 'GIGGLES', 'GLOWING', 'GOLDEN', 'HARMONY', 'HONEYED', 'JUBILEE', 'KISSES', 'LILIES',
      'LOVELY', 'MARBLE', 'MELLOWED', 'MOMENT', 'NURTURE', 'PEPPY', 'PEPPERM', 'PILLOW', 'PINKER', 'PUDDLE', 'PURELY',
      'QUAINT', 'ROSY', 'SAVORY', 'SEASIDE', 'SILKEN', 'SMOOTH', 'SNOWY', 'SOFTEN', 'SPARK', 'SPARKLE', 'SPROUTS', 'TENDER',
      'TIDY', 'TOASTY', 'TRUST', 'UNITY', 'UPLIFT', 'WHIMSY', 'WONDER', 'YUMMY'
    ],
    medium: [
      ...
      'TURING', 'UPLIFT', 'WISTER', 'AERIAL', 'ALPINE', 'ARTFUL', 'AVENUE', 'BASIL', 'BASKET', 'BEACON', 'BIRCH', 'BLOSSO',
      'BOREAL', 'BRAMBLE', 'BREEZED', 'BRIGHTEN', 'BURLAP', 'CANYON', 'CARBON', 'CARVED', 'CASCADE', 'CEDARS', 'CHERUB',
      'CINQUE', 'CLARITY', 'CLOUDED', 'COBALT', 'CONTOUR', 'COOLER', 'COTTAGE', 'COVERS', 'CRAFTER', 'CRATER', 'CRESCENT',
      'CUPOLA', 'CURFEW', 'DAYDREAM', 'DEWDROP', 'DOVISH', 'DRAFTED', 'DRAMEDY', 'EARFUL', 'ELEGY', 'EMBERS', 'ENDEAR',
      'FAIRWAY', 'FAVORS', 'FIDDLE', 'FLAVOR', 'FLORET', 'FLUTED', 'GALLANT', 'GARLIC', 'GLAZED', 'GOLDEN', 'GOSSIP',
      'GRAVEL', 'GREENS', 'HARBOR', 'HEARTHS', 'HERBAL', 'HOMELY', 'HUMBLE', 'INFLOW', 'INGLEN', 'JOURNAL', 'KETTLE',
      'LANTER', 'LATTES', 'LOFTED', 'MAPLES', 'MERGER', 'MORSEL', 'MUSLIN', 'NESTLE', 'NIMBUS', 'OAKENS', 'PAINTER', 'PASTEL',
      'PATCHES', 'PINEST', 'PIVOTS', 'PLAINS', 'PLEATS', 'POCKET', 'POLISH', 'PRIMRO', 'QUAINTS', 'QUARTS', 'QUINCE',
      'RADIATE', 'REPOSE', 'RIPPLE', 'RIVERED', 'SAVORY', 'SCENIC', 'SEASONS', 'SEAWAY', 'SHADOW', 'SHEATH', 'SHIMMER',
      'SIDING', 'SILKED', 'SILVER', 'SNOWED', 'SOLACE', 'SPRINGE', 'STABLE', 'STREAMY', 'SUNLIT', 'TASSEL', 'TIDIER',
      'TILLED', 'TRACED', 'TRAILS', 'TRIFLE', 'TWILIT', 'VALLEY', 'VERNAL', 'VIOLIN', 'VISTA', 'WARMED', 'WATERS', 'WILDER'
    ],
    hard: [
      ...
      'AEONIAN', 'ALCHEMY', 'APHELIA', 'AURICLE', 'BASILAR', 'BIVOUAC', 'CABALLO', 'CALDERA', 'CANTILE', 'CARILLON', 'CASSINI',
      'CELESTE', 'CENTAUR', 'CHIMERA', 'CHRISMA', 'CLAVIER', 'COBALTS', 'CONTOUR', 'COROLLA', 'CRATERS', 'CRYPTIC', 'DIADEMS',
      'DIALECT', 'DIFFRACT', 'DIOPTER', 'DORSALE', 'EIDOLON', 'ELDRICH', 'EMANATE', 'EMBRACE', 'ENCODED', 'EPITOME', 'ESOTERA',
      'FILIGRE', 'FLUXION', 'FOURIER', 'FRESNEL', 'GALACTI', 'GALENIC', 'GEODESY', 'GLIMMER', 'GRIMOIR', 'HELIAC', 'HELIXES',
      'HERALDS', 'HORIZON', 'HYBRIDS', 'IDYLLIC', 'IMMERSE', 'INERTIA', 'ISOGON', 'LACUNAE', 'LAMPLIT', 'LIMINAL', 'LITOTES',
      'LUCENCE', 'LUTHIER', 'MANTLES', 'MEANDER', 'MELODIC', 'MERIDIA', 'METONIC', 'MIRADOR', 'MURMURS', 'NOMADIC', 'NOVELLA',
      'OBSIDES', 'ORATORY', 'OSMOTIC', 'PARALLA', 'PATTERN', 'PHANTOM', 'PHYLUMS', 'PRAETOR', 'PREFACE', 'QUINTET', 'RAIMENT',
      'RESONIC', 'RHAPSOD', 'ROSTRUM', 'SATIATE', 'SEMAPHO', 'SEQUOIA', 'SOLSTIC', 'SPECTRE', 'SPIRALS', 'STELLAR', 'TACTILE',
      'TEMPEST', 'TESSERA', 'TORRENT', 'TRILITH', 'UMBRAEL', 'UNEARTH', 'VERISMO', 'VIBRANT', 'VITRINE', 'VORTEXE', 'WHITHER'
    ],
  },
  brainrot: {
    easy: [
      ...
      'PRESS', 'REALER', 'SHEESH', 'SLAPS', 'SNOW', 'TOXIC', 'ATTY', 'BABYGIRL', 'BAFF', 'BANGERZ', 'BASED', 'BEATS', 'BLOWUP',
      'BRATTY', 'CAMP', 'CHROMED', 'COZIED', 'CRAZED', 'CRAZE', 'CRONCH', 'DELULU', 'DOOT', 'EDITS', 'ENID', 'ESSKETIT',
      'FIDGET', 'FLAMER', 'FLIPS', 'FR', 'FROGGY', 'GLITZ', 'GRAILED', 'HEARTS', 'HITTY', 'HIZZIE', 'HOTTIE', 'HYPER', 'ILY',
      'ITSY', 'JIT', 'JOCK', 'KILLER', 'KIRB', 'KITTEN', 'LAYER', 'LEAK', 'MASHUP', 'MERCH', 'MESSY', 'MUNCH', 'OOMFS',
      'PREPPY', 'PULLUP', 'RAGERS', 'REACT', 'REMIX', 'SCENE', 'SHORTY', 'SLAPS', 'SLAYED', 'SLICED', 'SLUSH', 'SMH', 'SNARK',
      'SPAM', 'SPILL', 'SQUAD', 'SWIPE', 'TREND', 'TRILL', 'VIBED', 'VIBEY', 'ZESTY'
    ],
    medium: [
      ...
      'HYPEBAE', 'JUICED', 'LOKEY', 'SLAPPP', 'SPILL', 'TAPPIN', 'VIBECHK', 'ADHDCORE', 'ALTBAE', 'BARELY', 'BEEPBOOP',
      'BEMOODS', 'BIGSLAY', 'BIMBOS', 'BLORBO', 'BOBAPOP', 'BOTGIRL', 'BRAINGOO', 'BUBBLEG', 'CANCELD', 'CAPCUTS', 'CLOUTED',
      'CORELIT', 'CRINGEF', 'DELULAS', 'DIGICAM', 'DOOMBOX', 'EBOYSUP', 'EDITORS', 'FANGIRL', 'FANSHIP', 'FILTERY', 'FINSTA',
      'FRONTROW', 'FYPVIBE', 'GASSED', 'GLAZED', 'GLITCHY', 'GLOUPED', 'GOBLINY', 'GOLDFISH', 'GOOGLY', 'GOOSEY', 'GURLIES',
      'HYPERFI', 'ICONIC', 'INFLUEN', 'IRLCORE', 'ITSJUST', 'KEYSMAS', 'KPOPIFY', 'LILBRO', 'LIVELOL', 'MALDERS', 'MEMEIFY',
      'METAGIR', 'MICDROP', 'MOGGED', 'NAURRR', 'NETIZEN', 'OVERDOS', 'PFRIEND', 'PINTERE', 'PLUSHIE', 'POVSHOT', 'PRESTAN',
      'PRODDED', 'QUAKING', 'RATIOED', 'REPOSTS', 'RETCON', 'RIZZUP', 'SCENERS', 'SKRUNK', 'SKULLY', 'SLAYFUL', 'SLICING',
      'SMILER', 'SOFTPOP', 'SPLITDYE', 'SPOTIFY', 'STREAMY', 'SWIPEUP', 'SWORLS', 'SYNERGY', 'TAPBACK', 'TWEENIE', 'TWITTER',
      'TWIZZY', 'UPGRADE', 'VIBESET', 'WACKED', 'WEEBIT', 'WYS', 'ZAMN'
    ],
    hard: [
      'AESTHETE', 'ALTCORE', 'AUTOTUNE', 'BOPPING', 'BRAINROT', 'CANCELS', 'CLAPBACK', 'CLOUTED', 'CORECORE', 'CRINGING',
      'CRONCHY', 'CYBERLOL', 'DEEPFAKE', 'DELULUS', 'DISCORDS', 'DOOMCORE', 'DOWNVOTE', 'DREAMERS', 'DRIPDROP', 'DUPECORE',
      'FANBASES', 'FANFICS', 'FILTERS', 'FLEXTAPE', 'GASLIGHT', 'GHOSTING', 'GLITCHED', 'GLOWDOWN', 'GYATTING', 'HATEWAVE',
      ...
      'BRAINLIT', 'CLIQUEUP', 'DOOMSCRO', 'FYPCORE', 'HYPETOK', 'LOLCODES', 'SPARKLET', 'SWIFTTOK', 'ALGORITH', 'AUTOSCRO',
      'BRAINLEA', 'CAMPTOUR', 'CARRIED', 'CLIPBAIT', 'CLOUDRAP', 'CONTENTO', 'CRINGIFY', 'CYBERSPE', 'DISCOURC', 'DISCORDI',
      'DOOMPILL', 'DRIPFEST', 'EDITWARS', 'EMOTICON', 'ESCAPISM', 'FANEDITS', 'FANGIRLS', 'FANLORDS', 'FEEDLOOP', 'FILTERED',
      'FIREPOST', 'FLASHBAK', 'GASLIT', 'GLITCHER', 'GLOOPIFY', 'GOBLINED', 'GRAINFIL', 'HARDLAUF', 'HASHTAGS', 'HEADSPIN',
      'HYPERPIC', 'IMPACTOR', 'INFLUENC', 'KEYBOARD', 'LIVESTRE', 'LOREBOOK', 'MEMECORE', 'MENTIONS', 'MICCHECK', 'MIDSCROL',
      'MOGMOG', 'NETCROWN', 'NORMPILL', 'PARASOCI', 'PHONETIC', 'PLUGWALK', 'PODCRUSH', 'REACTION', 'REELSIDE', 'RETWEETA',
      'SCROLLIN', 'SHIPTALK', 'SKIBIDIB', 'SPAMPILE', 'SPOTLITE', 'STREAMER', 'SUGARGOS', 'TRENDIFY', 'TROLLAGE', 'TWITCORE',
      'ULTRAINF', 'UNSPOKEN', 'VIBEZONE', 'VIDEOGIR', 'VIRALIZE', 'ZOOMPAIN'
    ],
  },
  famous: {
    easy: [
      ...
      'VIN', 'WES', 'WILL', 'YARA', 'ZAYN', 'ELSA', 'LIAM', 'MEGAN', 'NINA', 'RUPA', 'SNOOP', 'TYRA', 'WIZ', 'AKON', 'BEBE',
      'BETH', 'BOW', 'BTS', 'CELIA', 'COCO', 'DAX', 'ENZO', 'ETTA', 'FKA', 'FLO', 'FOX', 'GLO', 'HANK', 'JON', 'JOJI', 'JONI',
      'KARL', 'KAT', 'LOR', 'MARS', 'MIKE', 'NEYO', 'PARI', 'PEELE', 'PHAR', 'RAYE', 'REX', 'REY', 'RIKO', 'ROSA', 'SAZA',
      'SHIA', 'SUKI', 'TANA', 'TATE', 'TOVE', 'TYE', 'VEVO', 'VIV', 'YOKO', 'ZARA'
    ],
    medium: [
      ...
      'GALLAG', 'JADEN', 'KANYEA', 'LUPIN', 'PHARRE', 'STEWAR', 'VIOLA', 'ABIGAIL', 'ADDISON', 'ALFONSO', 'AMANDLA', 'AMERICA',
      'ANDREWS', 'ANGELIA', 'ANTHONY', 'ARTHURS', 'ASTRID', 'BARBARA', 'BARLOWE', 'BENEDIC', 'BENTLEY', 'BIEL', 'BIGHIT',
      'BILLIEE', 'BOWEN', 'BRANDON', 'BRAYDEN', 'BRITTON', 'BRONSON', 'CALLIES', 'CAMERON', 'CAMPBEL', 'CANDACE', 'CARLSON',
      'CARMACK', 'CASSIAN', 'CHANNIN', 'CHESTER', 'CHIKWET', 'COGNITO', 'COLBERT', 'COLETTE', 'CORNELL', 'COYOTE', 'CRAWFOR',
      'DARLENE', 'DEMISEL', 'DESCHAM', 'DIMITRI', 'DONALDS', 'DUNHAM', 'ELLISON', 'ERSKINE', 'FAIRFAX', 'FENTY', 'FERRELL',
      'FLETCH', 'FONDA', 'GIBBONS', 'GIGI', 'GILLIG', 'GISH', 'GLOVER', 'GREER', 'GRETTA', 'HALLIE', 'HARTLEY', 'HEDLUND',
      'HENDERS', 'HILFIG', 'HUGHLEY', 'IVANKA', 'JACKSON', 'JAMISON', 'JANELLE', 'JANET', 'JASMINE', 'JIMMY', 'JOPLIN',
      'JULIETA', 'KATHERI', 'KELLY', 'KERR', 'KIKI', 'KITT', 'KRIS', 'KRISTI', 'LACEY', 'LAMAR', 'LANGDON', 'LARSEN', 'LEIGHT',
      'LENNONO', 'LEONARD', 'LILLY', 'LONNIE', 'MADDOX', 'MAEVE', 'MAJOR', 'MARLEY', 'MARQUEZ', 'MATHERS', 'MCADAMS',
      'MENDES', 'MERCER', 'MERYL', 'MORGAN', 'MORRIS', 'NAOMI', 'NEGRON', 'NESSA', 'PALEY', 'PAYTON', 'PENELOP', 'PHELPS',
      'PIERCE', 'PIPER', 'POINTER', 'POPPY', 'POTTER', 'PRESTON', 'REDDICK', 'RENEE', 'RITTER', 'ROGERS', 'ROONEY', 'ROWLAND',
      'SADIE', 'SAMARA', 'SAOIRSE', 'SASHA', 'SCHITT', 'SHANIAH', 'SHARON', 'SHEILA', 'SIDNEY', 'SINGH', 'SKYLAR', 'SNYDER',
      'SOMMER', 'SORKIN', 'STEFANI', 'STONE', 'SULLIV', 'SYKES', 'TORI', 'TRACEE', 'TRIPP', 'TRUMP', 'VANCE', 'VANESSA',
      'VERONIC', 'WADE', 'WALSH', 'WARREN', 'WHITNEY', 'WILLOW', 'ZAYNE', 'ZOEY'
    ],
    hard: [
      ...
      'MACRON', 'OPPENHE', 'PITTMAN', 'SANDOVAL', 'SPRADLEY', 'WINCHEST', 'ABRAMSON', 'ADKINS', 'ANDERSON', 'ANISTON',
      'ANNAPAK', 'BALDWIN', 'BANDERAS', 'BARTHES', 'BAYWATCH', 'BIEGEL', 'BILLBURR', 'BLANCHET', 'BOLLYWOO', 'BRANDOJR',
      'BRIDGERS', 'CARAMEL', 'CARPENTR', 'CARTIERS', 'CHALAMET', 'CLARKSON', 'COBALTBL', 'COLLIDER', 'DASHING', 'DAVELANE',
      'DELEVING', 'DERULO', 'DEYOUNG', 'DIONYSUS', 'DUCHOVNY', 'EUPHORIA', 'FAVELLA', 'FEY', 'FLEABAG', 'FLOORIDA', 'FOWLER',
      'FREDDIE', 'GALLAGAR', 'GAMBINO', 'GARLAND', 'GIGGS', 'GILLIAM', 'GILMORE', 'GLOVERJR', 'GOTYE', 'GRANDE', 'GREENDAY',
      'GUGUDAN', 'HADER', 'HALLYU', 'HARRY', 'HATHAWAY', 'HENDRICK', 'HERMIONE', 'HILTON', 'HOPKINS', 'IDRISALB', 'JACKSONS',
      'JAMESCO', 'JANES', 'JAYPARK', 'JIGGA', 'JOPHIEL', 'JOVOVICH', 'JULIANNE', 'KARDASH', 'KIDCU', 'KILLMONG', 'KIMMEL',
      'KIRKMAN', 'KOFFMAN', 'KRAVITZS', 'LARSON', 'LAUDER', 'LILHUDDY', 'LIZZO', 'LOHAN', 'LUPONE', 'MAHERSHA', 'MARTYMCF',
      'MAYWEATH', 'MCQUEEN', 'MENDL', 'MERCURY', 'MORISSET', 'MOSS', 'MULANEY', 'NEPTUNE', 'NIRVANA', 'OLIVIARO', 'OSBOURNE',
      'PATTI', 'PFEIFFER', 'PHOEBE', 'PIPPA', 'PITTBULL', 'POSTY', 'QUEENB', 'REDFORD', 'REYNOLDS', 'ROBINSON', 'RODWAVE',
      'SANDRAO', 'SCHWARZ', 'SCHWEIG', 'SCORSESE', 'SHERIDAN', 'SODERBER', 'STATHAM', 'STILLER', 'STYLES', 'SUDEIKIS', 'SUZUKI',
      'TARON', 'THERON', 'TIKTOKER', 'TINA', 'TOMLIN', 'TOPGUN', 'VIOLA', 'WALLACE', 'WATSON', 'WINCHEST', 'WINSTONA', 'YEEZY'
    ],
  },
  games: {
    easy: [
      ...
      'ZUMA', 'FROGGER', 'PACMAN', 'SIMS', 'TETRIS', 'TEMTEM', 'VECTREX', 'AEROBI', 'AMIGA', 'BLOONS', 'BOMBER', 'BUDOKA',
      'CIV', 'COCOON', 'COLONY', 'CORTEX', 'CRAFT', 'CURSE', 'DIZZY', 'ELITE', 'FARON', 'FLOCK', 'FROSTY', 'FUSER', 'GALAGA',
      'GAUNTL', 'GLIDER', 'GUILD', 'HYPER', 'INDIE', 'ISK', 'JAMMER', 'KENA', 'KIRBY', 'KORRA', 'KUBO', 'LODE', 'LOTUS', 'LUIGI',
      'MAPPY', 'METRO', 'MIDGAR', 'MOSS', 'NERO', 'NOVA', 'OSU', 'PANIC', 'PEGL', 'PLAGUE', 'PIXEL', 'PLANTS', 'POPIT', 'PRISM',
      'PUYO', 'REROLL', 'RHYTHM', 'RIDER', 'RUNE', 'SABLE', 'SAMUS', 'SEGA', 'SHARK', 'SHINY', 'SMITE', 'SPAWN', 'SPLICE',
      'SPY', 'STELLA', 'SUNNY', 'SWITCH', 'TALES', 'TANGO', 'TETRA', 'TRACK', 'TRIAL', 'TURBO', 'TWIST', 'VITA', 'VOXEL', 'WARP'
    ],
    medium: [
      ...
      'CITIZEN', 'DRIFTER', 'HALCYON', 'STARCRA', 'ABDUCTOR', 'ACEATT', 'ALBEDO', 'ALIENIS', 'ANNIHIL', 'ARCADIA', 'ARMELLO',
      'ASCENT', 'AURION', 'AZUREDR', 'BANDICO', 'BAYONET', 'BEYONDT', 'BIOMUT', 'BIONIC', 'BIONITE', 'BITTRIP', 'BULLET',
      'CALIBER', 'CHRONOS', 'CLANK', 'CODEVEI', 'COLONYS', 'CRIMSON', 'CROTEAM', 'CYBERIA', 'CYTUS', 'DAUNTLE', 'DAYGONE',
      'DEMONSS', 'DISCO', 'DIVINIT', 'DRAGONN', 'DUSTFOR', 'ECHO', 'EMBERS', 'ESCAPIS', 'EVOLVE', 'EXOPRIM', 'FREEMAN',
      'FROSTPU', 'GAIA', 'GAUNTLE', 'GENSHI', 'GRANBLU', 'GRAVITY', 'GREEDFA', 'GUILDWA', 'GUNGODZ', 'HADESII', 'HARDSPA',
      'HEROESH', 'HITMAN', 'HORIZON', 'IMMORTA', 'INJUSTI', 'JEDI', 'JETSET', 'JUDGMEN', 'KILLER', 'LASTLIG', 'LEMMING',
      'LITTLEN', 'MAGNETA', 'MANEATE', 'METROID', 'MIDNIGH', 'MILLENN', 'MIRRORS', 'MUTANTY', 'NEPTUNI', 'NETHER', 'NEXUS',
      'NIER', 'NIOH', 'NOCTURN', 'OBLIVIO', 'ORWELL', 'OUTERLD', 'OUTRIDR', 'PAPERMR', 'PILGRIM', 'PREY', 'PUNCHOU', 'QUANTUM',
      'REMAKE', 'RESOGUN', 'REVENAN', 'SABLE', 'SCARLET', 'SCORN', 'SEAOFTH', 'SHANTAE', 'SHOVELK', 'SIFU', 'SKATER', 'SKIES',
      'SLAYSPI', 'SPELUNK', 'SPITFIR', 'SPLOPIO', 'STARLIN', 'STARSEA', 'STELLAR', 'SUNLESS', 'SURVIVO', 'TARIS', 'THEWALK',
      'THIEVES', 'TRANSIS', 'TROVERS', 'TUNIC', 'ULTRAKI', 'VAMPIRE', 'WARGROO', 'XCOM', 'YOSHIIS'
    ],
    hard: [
      ...
      'APEXLEGN', 'DEATHLOO', 'FORSPOK', 'REMNANT', 'RETURNAL', 'SABLE', 'SCORN', 'STRAYGOD', 'AGEEMPI', 'AMNESIA', 'ANACHRO',
      'ANEURYS', 'ARMOREDC', 'ATELIER', 'BALDURS', 'BATTLETE', 'BLACKMES', 'BORDERLA', 'BREAKPO', 'BRIGADOR', 'CHERNOBL',
      'CHROMAP', 'CODEBREE', 'COMMANDO', 'CONTRA', 'CRUSADER', 'DARKMESS', 'DAYZ', 'DELTAV', 'DEMONTO', 'DESPERAD', 'DEVILMAY',
      'DISGAEA', 'DIVISION', 'DOOMETR', 'DYINGLIG', 'EARTHBOU', 'ENDLESS', 'ESCAPEFR', 'EVILWITH', 'FATEEXT', 'FREELANC',
      'FROMSOFT', 'GEARSTAC', 'GRIMFAND', 'HADESGOD', 'HALOINF', 'HELLDIVE', 'HELLRAID', 'HITMANWO', 'HORIZERO', 'IMMORTAL',
      'INFINITE', 'JAGGEDAL', 'KENA', 'KINGDOMC', 'LASTLIG', 'LOU2', 'MANEAT', 'MEGAMAN', 'MERCENAR', 'MIRRSEDG', 'NEPTUNIA',
      'OUTWORLD', 'PATHOFEX', 'PLAGTALE', 'PRAYERS', 'PREYMOON', 'PSYCHONA', 'QUAKEIII', 'RAZORTO', 'RECORE', 'RESID7',
      'REVIL4', 'ROGUELG', 'SIFU', 'SOMA', 'SOULSBOR', 'STALKER', 'STARCIT', 'STYX', 'TEKKEN', 'THI4F', 'TITANQUE', 'TOEM',
      'TORCHLI', 'TRIANGLE', 'TW3', 'VALKYRIA', 'WOLFTOT', 'WONDER', 'WOTLK', 'XENOGEA', 'YSVIII'
    ],
  },
};
